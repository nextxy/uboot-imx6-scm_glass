...
const char jifang_logo_str[] = "Copyright @ 2016 JiFang Electric Co.,Ltd. All Rights Reserved.";
...
/* Locals */
GraphicDevice *pGD;	/* Pointer to Graphic array */
...
static void plot_logo_or_black(void *screen, int width, int x, int y,	\
			int black);
//gao
#define xxx (((pGD->winSizeX)-VIDEO_LOGO_WIDTH)/2)
#define yyy (((pGD->winSizeY)-video_logo_height)/2)
...
void *video_logo(void)
{
	...
	if (s != NULL) {
        ...
        // printf("video_logo splash_screen\n");
	...
	if (board_cfb_skip())
		return 0;
	// wyb
//	sprintf(info, " %s", jifang_logo_str);
...
#if 1
 LCD_DrawRectangle(100,100,200,200,0xffff);
LCD_Draw_Circle1(100,100,50,0x6666);
LCD_Fill(200,200,220,220,0x4444);
LCD_Straight_Line(600,400,50);
LCD_DrawLine(500,200,700,200,0x4343);
#endif
